...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $service_type = "Fire Alarm Protection Works";
...
<div class="form-container">
    <div class="form-content">
        <h2>Book Fire Alarm Protection Works</h2><br>
        <form method="post" action="" enctype="multipart/form-data">
            <label for="service_type">Service Type:</label><br>
            <input type="text" id="service_type" name="service_type" value="Fire Alarm Protection Works" readonly><br><br>
