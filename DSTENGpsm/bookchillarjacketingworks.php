...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $service_type = "Chiller Pipe Jacketing Works";
...
<div class="form-container">
    <div class="form-content">
        <h2>Book Chiller Pipe Jacketing Works</h2><br>
        <form method="post" action="" enctype="multipart/form-data">
            <label for="service_type">Service Type:</label><br>
            <input type="text" id="service_type" name="service_type" value="Chiller Pipe Jacketing Works" readonly><br><br>
